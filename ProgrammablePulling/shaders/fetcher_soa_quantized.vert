...
void main(void) {
	...
	vec3 inVertexNormal;
	inVertexNormal.x   = texelFetch(normalXBuffer, gl_VertexID).x * 2.0 - 1.0; 
	inVertexNormal.y   = texelFetch(normalYBuffer, gl_VertexID).x * 2.0 - 1.0; 
	inVertexNormal.z   = texelFetch(normalZBuffer, gl_VertexID).x * 2.0 - 1.0; 
